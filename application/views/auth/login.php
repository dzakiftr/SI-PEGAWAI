...
<head>
  ...
  <title>Ruang Ide Nusantara | Login</title>
...
<body style="background-image:url(<?php echo base_url() ?>assets/images/back.jpg);background-size:cover;" class="hold-transition login-page">
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Ruang</b>Ide</b><b>Nusantara</b></a>
  </div>
  <!-- /.login-logo -->
