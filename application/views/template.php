      ...
      <div class="wrapper">
          <header class="main-header">
              ...
              <a href="#" class="logo">
                  ...
                  <span class="logo-mini"><b>R</b>I<b>N</b></span>
                  <!-- logo for regular state and mobile devices -->
                  <span class="logo-lg"><b>Ruang</b>Ide<b>Nusantara</b></span>
              </a>
                  ...
                  <div class="navbar-custom-menu">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url()?>template/dist/img/userwow.jpg" class="user-image" alt="User Image">
                                  <span class="hidden-xs"> <?=$user->first_name?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="<?php echo base_url()?>template/dist/img/userwow.jpg" class="img-circle" alt="User Image">
                                    <p>
                      ...
                      <li>
                          ...
                          <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="gaji"><i class="fa fa-angle-double-right"></i> Hitung Gaji</a></li>
                                <li><a href="pekerjaan"><i class="fa fa-angle-double-right"></i> Data Pekerjaan</a></li>
                                <li><a href="karyawan_gaji"><i class="fa fa-angle-double-right"></i> Data Karyawan</a></li>
                            </ul>
                        </li>

                          <!-- <a href="<?php echo base_url('pekerjaan') ?>">
                              <i class="fa fa-user"></i> <span>Pekerjaan</span>
                          </a>

                          <a href="<?php echo base_url('gaji') ?>">
                              <i class="fa fa-money"></i> <span>Hitung Gaji</span>
                          </a> -->
                          ...
                          <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="gaji/lap_karyawan"><i class="fa fa-angle-double-right"></i> Laporan Data Karyawan</a></li>
                                <li><a href="gaji/lap_gajikaryawan"><i class="fa fa-angle-double-right"></i> Laporan Gaji Karyawan</a></li>
                            </ul>
                        </li>
                      </li>
          ...
          <footer class="main-footer">
              ...
              <strong> &copy; 2019 <a href="#">RuangIdeNusantara</a>.</strong> All rights reserved.
          </footer>
