...
class Karyawan_gaji extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Karyawann_model');
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->Karyawann_model->total_rows($q);
        $karyawan = $this->Karyawann_model->get_limit_data($config['per_page'], $start, $q);
    ...
    {
        $row = $this->Karyawann_model->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Karyawann_model->insert($data);
    ...
    public function update_action() 
    {
		...
		'id_pekerjaan' => $this->input->post('id_pekerjaan',TRUE),
            ...
            $this->Karyawann_model->update($this->input->post('id_karyawan', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Karyawann_model->delete($id);
